  ...
  return (
    <div className="relative grid min-h-screen lg:grid-cols-[minmax(0,1fr)_minmax(420px,0.72fr)]">
      ...
      <div className="flex flex-col justify-center px-6 py-12 md:px-16 lg:px-24">
        <Link to="/" className="mb-12 flex items-center gap-2.5 self-start"><span className="flex h-8 w-8 items-center justify-center rounded-lg bg-primary text-primary-foreground"><GraduationCap className="h-4.5 w-4.5" /></span><span className="font-display text-lg font-extrabold tracking-tight">ESQUARE</span></Link>
        <div className="w-full max-w-md">
          <h1 className="text-3xl font-bold">Welcome back</h1>
          <p className="mt-2 text-sm text-muted-foreground">Use the same verified account for every institution.</p>
